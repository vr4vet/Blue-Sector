...
public class NPCToPlayerReferenceManager : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        {
            Debug.LogError(
                "You need to assign a PlayerTarget to the NPCToPlayerReferenceManager. Many of the NPC scripts need this variable to function"
            );
        }
        if (PlayerCollider == null)
        {
            Debug.LogError(
                "You need to assign a PlayerCollider to the NPCToPlayerReferenceManager. Many of the NPC scripts need this variable to function"
            );
        }
    }
