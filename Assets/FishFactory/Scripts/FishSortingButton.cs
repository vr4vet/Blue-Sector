...
public class FishSortingButton : MonoBehaviour
{
    ...
    {
        // Load materials
        tier1 = Resources.Load<Material>("Materials/QAPannel/Tier1");
        tier2 = Resources.Load<Material>("Materials/QAPannel/Tier2");
        tier3 = Resources.Load<Material>("Materials/QAPannel/Tier3");
        ...
        ColorPannel = GameObject.Find("ColorBox");
    }
    ...
    public void setTier1()
    {
        ...
        ColorPannel.GetComponent<Renderer>().material = tier1;
        Debug.Log(currentFishTier);
    }
    public void setTier2()
    {
        currentFishTier = FishTier.Tier2;
        ColorPannel.GetComponent<Renderer>().material = tier2;
        Debug.Log(currentFishTier);
    }
    public void setTier3()
    {
        currentFishTier = FishTier.Tier3;
        ColorPannel.GetComponent<Renderer>().material = tier3;
        Debug.Log(currentFishTier);
    }
}
